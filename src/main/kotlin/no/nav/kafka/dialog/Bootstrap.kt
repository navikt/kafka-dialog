...
val application: KafkaPosterApplication = KafkaPosterApplication(
    filter = FilterSetting.valueOf(env(config_FILTER)).filter,
    modifier = ModifierSetting.valueOf(env(config_MODIFIER)).modifier
