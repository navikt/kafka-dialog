...
class ArenaTestApplication : App {
    ...
    override fun start() {
        log.info { "Starting arena test app ${system.env(env_DEPLOY_APP)} - cluster ${system.env(env_DEPLOY_CLUSTER)} with poster settings ${system.envAsSettings(env_POSTER_SETTINGS)}" }
        enableNAISAPI {
